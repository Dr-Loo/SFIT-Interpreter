...
# Estimated tetrahedron count post-fill
n = 3
# Manual connectivity: assume a triangle loop (each connects to two others)
A = np.array([[0, 1, 1],
              [1, 0, 1],
              [1, 1, 0]])
...
# Genus fingerprint (SFIT-inspired)
a0 = 1.0
a1 = float(np.mean(phi))
a2 = float(np.mean(phi**2))

print(f"SFIT genus vector for m019(1,2) (triangle adjacency):")
print(f"a0 = {a0:.3f}")
print(f"a1 = {a1:.3f}")
print(f"a2 = {a2:.3f}")
